...
public class DescriptionItemDefaultNoWeapon : DescriptionItem
{
    public int DamageForStack = 5;//надо заменить
    public int SpendStack = 2;//надо заменить
    public void SetTextBody()
    {
        string text = "start battle: give <u>" + Armor.ToString() + "</u>\r\n\r\nfire items      activate:  will spend <u>" 
            + SpendStack.ToString() + "</u>       and deal <u>" + DamageForStack .ToString() + "</u> damage";
        textBody.text = text;
    }
