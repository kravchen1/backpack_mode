...
{
    public int powerStack = 5;//надо заменить
    public int powerStackChance = 5;
    public void SetTextBody()
    {
        string text = "Асtivating an item with       gives you a <u>" + powerStackChance.ToString() + "</u>% chance to gain <u>" + powerStack.ToString() + "</u>";
        textBody.text = text;
    }
