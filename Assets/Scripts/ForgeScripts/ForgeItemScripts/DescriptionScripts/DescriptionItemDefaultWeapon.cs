...
public class DescriptionItemDefaultWeapon : DescriptionItem
{
    public int hitFireStack;//надо заменить
    public int dropFireStack;//надо заменить
    public int dealDamageDropStack;//надо заменить
