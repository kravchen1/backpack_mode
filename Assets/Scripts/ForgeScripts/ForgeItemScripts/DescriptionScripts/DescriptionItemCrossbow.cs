...
public class DescriptionItemCrossbow : DescriptionItem
{
    ...
    {
        string text = "On hit: Gives a <u>" + bleedingChance.ToString() + "</u>% chance to\r\ninflict <u>" + bleedingStack.ToString() + "</u>";
        textBody.text = text;
    }
