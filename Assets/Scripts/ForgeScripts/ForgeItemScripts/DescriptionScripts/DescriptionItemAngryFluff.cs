...
public class DescriptionItemAngryFluff : DescriptionItem
{
    public int removesRandomDebuff;//надо заменить
    ...
    {
        string text = "On hit: removes <u>" + removesRandomDebuff.ToString() + "</u> random debuff";
        textBody.text = text;
    }
