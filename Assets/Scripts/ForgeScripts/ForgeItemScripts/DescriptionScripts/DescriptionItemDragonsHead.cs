...
public class DescriptionItemDragonsHead: DescriptionItem
{
    ...
    {
        string text = "every activation gives you <u>" + fireStack.ToString() + "</u>\r\nEvery dragon and fire      item gives you +<u>" + starActivation.ToString() + "</u>% faster activation";
        textBody.text = text;
    }
