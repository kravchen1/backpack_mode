...
public class DescriptionItemDragonsWing: DescriptionItem
{
    ...
    {
        string text = "On hit: gives you <u>" + evasionStack.ToString() + "</u>\r\nand unflict <u>" + blindnessStack.ToString() + "</u>       on enemy";
        textBody.text = text;
    }
